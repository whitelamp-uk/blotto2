...
CREATE TABLE IF NOT EXISTS `blotto_org` (
  ...
  `anl_cm_id` varchar(64) COLLATE 'ascii_general_ci',
  `signup_cm_key` varchar(255) CHARACTER SET ascii DEFAULT NULL,
  `signup_cm_id` varchar(64) CHARACTER SET ascii DEFAULT NULL,
  `signup_cm_id_verify` varchar(64) CHARACTER SET ascii DEFAULT NULL,
  `signup_cm_id_trigger` varchar(64) CHARACTER SET ascii DEFAULT NULL,
  `signup_ticket_options` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
